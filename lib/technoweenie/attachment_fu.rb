      ...
      protected
        ...
        if ActiveSupport.const_defined?(:Callbacks)
         ...
         #   options.reverse_merge!( :object => self )
            # Removed because I am not using and also becaucse of
            # http://blog.thefrontiergroup.com.au/2011/03/accessing-activerecord-and-activemodel-callback-chains-in-rails-3/
